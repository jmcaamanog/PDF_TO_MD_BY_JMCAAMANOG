# 🛡️ Política de Seguridad (O cómo evitar que la IA domine el mundo)
...
Si has estado trasteando y has encontrado un agujero negro (ya sabes: un *path traversal* loquísimo, un error que expone datos o rompe el aislamiento offline de tu máquina local), haz el favor de decírmelo en *petit comité*:
...
Te prometo que te responderé en un máximo de **5 días hábiles** (normalmente soy más rápido, a menos que esté entrenando para mi próximo 10K, programando una nueva locura ConTech o de paseo). Una vez verifiquemos y parchemos el agujero, te pondremos una medalla en las notas de la *release* para que puedas presumir de *hacker* ético, salvo que prefieras el anonimato rollo Batman.
